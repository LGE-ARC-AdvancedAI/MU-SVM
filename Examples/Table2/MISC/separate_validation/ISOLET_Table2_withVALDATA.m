function [RPred1OVA,RPredU1OVA,Remp1OVA,RempU1OVA,Finmodel1OVA,Finoutput1OVA,FinmodelU1OVA,FinoutputU1OVA,optparam1OVA,...
    ...
    RPred2,RPredU2,Remp2,RempU2,Finmodel2,Finoutput2,FinmodelU2,FinoutputU2,optparam2]=ISOLET_Table2_withVALDATA()
%--------------------------------------------------------------------------
% DESCRIPTION:
...
for i=1:expno
    ...
    [trndata,valdata,tstdata,univ1]=isoletdata_MULTI([1,2,3,4,5],100,100,[],[6:26],24);  % Others universum
