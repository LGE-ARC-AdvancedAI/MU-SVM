...
for i=1:expno
    ...
    [trndata,valdata,tstdata,univ1]=abcdetcdataMULTI([53:56],150,0,100,[1:25],20); % Training '0' - '3', Universum 'lowercase'
    ...
    [RPred3OVA(i),RPredU3OVA(i),Remp3OVA(i),RempU3OVA(i),Finmodel3OVA(i),Finoutput3OVA(i),FinmodelU3OVA(i),FinoutputU3OVA(i),optparam3OVA(i)]=ExpwithCVRBFOVA_MAT(trndata,tstdata,univ3,param);
    [RPred3OVO(i),RPredU3OVO(i),Remp3OVO(i),RempU3OVO(i),Finmodel3OVO(i),Finoutput3OVO(i),FinmodelU3OVO(i),FinoutputU3OVO(i),optparam3OVO(i)]=ExpwithCVRBFOVO_MAT(trndata,tstdata,univ3,param);
    [RPred3(i),RPredU3(i),Remp3(i),RempU3(i),Finmodel3(i),Finoutput3(i),FinmodelU3(i),FinoutputU3(i),optparam3(i)]=ExpwithCVRBFMUSVM(trndata,tstdata,univ3,param);
    
    
    [RPred4OVA(i),RPredU4OVA(i),Remp4OVA(i),RempU4OVA(i),Finmodel4OVA(i),Finoutput4OVA(i),FinmodelU4OVA(i),FinoutputU4OVA(i),optparam4OVA(i)]=ExpwithCVRBFOVA_MAT(trndata,tstdata,univ4,param);
    [RPred4OVO(i),RPredU4OVO(i),Remp4OVO(i),RempU4OVO(i),Finmodel4OVO(i),Finoutput4OVO(i),FinmodelU4OVO(i),FinoutputU4OVO(i),optparam4OVO(i)]=ExpwithCVRBFOVO_MAT(trndata,tstdata,univ4,param);
    [RPred4(i),RPredU4(i),Remp4(i),RempU4(i),Finmodel4(i),Finoutput4(i),FinmodelU4(i),FinoutputU4(i),optparam4(i)]=ExpwithCVRBFMUSVM(trndata,tstdata,univ4,param);
